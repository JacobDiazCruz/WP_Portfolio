...
function plaintext_scripts() {
  ...
  wp_enqueue_script( 'dist', get_theme_file_uri('/js/dist/smooth-scrollbar.js')  , array(), null, true);
  ...
  // scrollmagic file
  wp_register_script('Scrollmagic', get_theme_file_uri('/js/uncompressed/ScrollMagic.js'), null, null, true);
  wp_enqueue_script('Scrollmagic');

  // fontawesome cdn
  wp_register_style('fontawesome', 'https://use.fontawesome.com/releases/v5.7.1/css/all.css', null, null, false);
  wp_enqueue_style('fontawesome');
  wp_enqueue_style('Poppins', 'https://fonts.googleapis.com/css?family=Poppins:300');
  wp_enqueue_style('Montserrat', 'https://fonts.googleapis.com/css?family=Montserrat:700');
